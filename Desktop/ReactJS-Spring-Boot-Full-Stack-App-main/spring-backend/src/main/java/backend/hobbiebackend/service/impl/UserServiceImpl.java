...
public class UserServiceImpl implements UserService {
    ...
    public BusinessOwner findBusinessOwnerById(Long id) {
        return this.businessOwnerRepository.findById(id).orElseThrow(() -> new NotFoundException("Can not find business owner"));
    }

    @Override
    public UserEntity findUserByUsername(String username) {
        return this.userRepository.findByUsername(username).orElseThrow(() -> new NotFoundException("Can not find user with this username"));
    }
    ...
    public AppClient findAppClientById(Long clientId) {
        return this.appClientRepository.findById(clientId).orElseThrow(() -> new NotFoundException("Can not find current user."));
    }
    ...
    public boolean businessExists(String businessName) {
        return this.businessOwnerRepository.findByBusinessName(businessName).isPresent();
    }
    ...
    public BusinessOwner findBusinessByUsername(String username) {
        return this.businessOwnerRepository.findByUsername(username).orElseThrow();
    }
}